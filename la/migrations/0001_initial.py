# Generated by Django 4.1.1 on 2023-01-31 07:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='la.category')),
                ...
                ('in_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='la.list')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_added', models.DateField(auto_now_add=True)),
                ('for_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='la.list')),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to_get_from', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='la.merchant')),
            ],
            options={
                'ordering': ['description'],
            },
        ...
        migrations.AddField(
            model_name='category',
            name='in_group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='la.list'),
        ),
    ]
